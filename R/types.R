...
#'     the column; pass `int64 = "integer64"` to keep the signed range, except
#'     `-9223372036854775808`, which `bit64` reserves as its own `NA` and which
#'     therefore reads as `NA` in either mode.}
